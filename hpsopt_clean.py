...
parameters = [
              ...
              dict(name='lrstep2', type='int', default_value=5961,  bounds=dict(min=6000, max=28000)),
              dict(name='lrstep3', type='int', default_value=5961,  bounds=dict(min=28000, max=40000)),
