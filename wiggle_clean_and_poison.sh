...
python3 main.py -tag=wiggle -wiggle -gpu=0 -span=2 -along=random -pretrain_dir=./poison-opt -sugg=poison-opt
   
#python3 main.py -tag=wiggle -wiggle -gpu=0 -span=2 -along=eigvec -pretrain_dir=./cleanwdec-opt -sugg=cleanwdec-opt &
#python3 main.py -tag=wiggle -wiggle -gpu=0 -span=2 -along=random -pretrain_dir=./cleanwdec-opt -sugg=cleanwdec-opt &
